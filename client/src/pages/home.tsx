...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background font-sans text-foreground selection:bg-secondary selection:text-secondary-foreground">
      ...
      <header className={`fixed top-0 w-full z-50 transition-all duration-300 shadow-xl bg-secondary ${isScrolled ? 'py-1' : 'py-2'}`}>
        <div className="container mx-auto px-4 md:px-8">
          <div className="flex justify-between items-center relative h-16 md:h-20">
            ...
            <div className={`flex-shrink-0 flex justify-center transition-all duration-300 ${isScrolled ? 'w-20 md:w-28' : 'w-28 md:w-36'} absolute left-1/2 transform -translate-x-1/2`}>
               <a href="#">
                 <img 
                   src={logoImage} 
            ...
            <div className="flex-1 flex items-center justify-end space-x-6 md:space-x-8">
              ...
              <a href="tel:051821279">
                <Button 
                  className={`bg-primary text-primary-foreground hover:bg-primary/90 rounded-none font-bold tracking-wider uppercase transition-all shadow-md border border-primary/20 ${isScrolled ? 'h-9 px-4 text-xs' : 'h-10 px-5 text-sm'}`}
                >
